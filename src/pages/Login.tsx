        ...
        <SignIn 
          ...
          appearance={{
            elements: {
              ...
              headerTitle: "text-xl font-semibold text-foreground empty:hidden before:content-['Entrar']",
              headerSubtitle: "text-muted-foreground empty:hidden before:content-['para_continuar_no_TrafficTracker']",
              formButtonPrimary: "bg-primary hover:bg-primary/90 text-primary-foreground before:content-['Entrar']",
              ...
              footerActionLink: "text-primary hover:underline before:content-['Cadastre-se']",
              ...
              footerAction: "text-foreground before:content-['Não_tem_uma_conta?_']",
              ...
              formFieldAction__forgotPassword: "text-primary hover:underline before:content-['Esqueceu_a_senha?']",
              ...
              formFieldInputPasswordInput: "placeholder:text-muted-foreground/70 placeholder:content-['Digite_sua_senha']"
            },
            variables: {
